...
```javascript
ctors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-complex-ctors@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-complex-ctors@umd/bundle.js"></script>
```
...
<html lang="en">
<body>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-complex-dtypes@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-complex-ctors@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
